...
export class inicialMigration1653332398751 implements MigrationInterface {
    name = 'inicialMigration1653332398751'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "students" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "address" character varying NOT NULL, "entry_time" character varying NOT NULL, "departure_time" character varying NOT NULL, "parentId" uuid, "schoolId" uuid, "driverId" uuid, CONSTRAINT "PK_7d7f07271ad4ce999880713f05e" PRIMARY KEY ("id"))`);
